...
/**
 * This is demo takes an XML file, transforms the model, converts it to JSON and POSts it to a REST API
 */
public class PostDemo {

  private static Logger logger = LoggerFactory.getLogger(PostDemo.class);
  ...
  private void boot(Path input, Path output, Path error) throws Exception {
    ...
    RouteBuilder routeBuilder = new PostRoute(input, output, error);
